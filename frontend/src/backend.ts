...
import type { BinState as _BinState, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addAlert(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async dispatchCollection(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllBins(): Promise<Array<BinState>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBins();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBinState(arg0: string): Promise<BinState | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBinState(arg0);
    ...
    async getCollectionLog(): Promise<Array<CollectionLogEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCollectionLog();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBinFillLevel(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBinFillLevel(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BinState]): BinState | null {
